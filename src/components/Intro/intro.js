  ...
  return (
    <section id="intro">
      <div className="introContent">
          ...
          <span className="introSocial"><a href="https://www.instagram.com/sameera_0108/" rel='noreferrer'><i className='bi bi-instagram' style={{color:'black'}}></i></a> <a href="https://twitter.com/Sameera0108" target="_blank" rel='noreferrer'><i className='bi bi-twitter' style={{color:'black'}}></i></a> <a href="https://www.linkedin.com/in/m-bhargavee-sameera-008b09234/" target="_blank" rel='noreferrer'><i className='bi bi-linkedin' style={{color:'black'}}></i></a>  <a href="https://github.com/infi-bins-loop" target="_blank" rel='noreferrer'><i className='bi bi-github' style={{color:'black'}}></i></a></span>
      </div>
